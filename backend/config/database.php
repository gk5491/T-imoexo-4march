...
class Database
{
    ...
    public function __construct()
    {
        ...
        // Set database configuration for cPanel
        $this->host = trim(getenv('DB_HOST') ?: '82.25.105.94');
        $this->db_name = trim(getenv('DB_NAME') ?: 'timoexo_db');
        $this->username = trim(getenv('DB_USER') ?: 'timoexo_db');
        $this->password = trim(getenv('DB_PASSWORD') ?: 'Cybaem@000');
